      ...
      <Row>
        ...
        <Col>
          ...
          <p>
            ...
            web-portfolio. Utilizing a culmination of ideas from Flatiron School
            and principles in my own studies. Resume's usually depict an
            accurate picture of someones past job & project history but I wanted
            to create something different, more tangible.
          </p>
          <br></br>
          <h3 align="center">Bring in TimeLine App.</h3>
          <p>
            A web-app that literally shows the flow of events that brought you
            to where you currently are. Then later in my portfolio another page
            will connect the User/Client with a Resume to view/download. I've
            done interviews for HR departments before and have always said that
            being personable is better than what is in the black & white of your
            resume.
          </p>
          <p>
